...
오피스텔을 알아보는 경우 생각하는 월세보다 더 높은 조건으로 잡는 편이 좋을 수 있음. 예를 들어 월세, 관리비, 공과금 모두 합한 금액을 70만원으로 예상하고 있다면, 월세금 조건을 60만원으로 설정하는 것이 합리적인 것처럼 보임. 그러나 굉장히 드물기는 하지만 70만원에 관리비 없고 수도세, 전기세 등 모두가 포함되어 있는 경우도 있음(극단적인 사례이긴 함).
...
- 사당동
- 잠실(비쌈)
- 천호동, 길동(살기 좋은 동네인데, 간혹 좋은 매물이 나올 때 있는 것으로 보임.)
- 보라매(?)
