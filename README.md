...
풀옵션, 근린생활시설 X, 3층 이상, 10년 이내, 중소기업취업청년 전월세보증금대출 100% 등의 조건으로 서울대역, 낙성대역 근처 매물이 있는지 한 공인중개사(이 공인중개사가 이 지역 매물이 많음. 이름은 2음.)에 문자로 문의를 남겼음. 그런데 전화가 왔고 한 곳이 있다고 함. 통화 당시 내부 사진은 세입자가 있어서 없다고 했고, 필자는 해당 건물 주소를 요구했음. **그런데 해당 건물 주소로 건축물대장을 열람해보니 2003년 증축이 있었던 것 확인**. 즉 10년 이내 건물이 아니라는 것. 토요일에 방문하겠다고 했는데, 헛걸음이었을 것임.
